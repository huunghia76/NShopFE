...
function About(params) {
  return (
    <>
      ...
      <div className="container"><p className="text-center fw-bold fa-3x">About</p>
        <div className="row">
          <div className="col col-8">
            ...
            <p>
              ...
              especially when it comes to coloring and high
lights. If you have
          ...
          <div className="col col-4 text-center py-4 ">
            ...
            <div className="row">
                <div className="col my-4 ">
                    <div className=" border border-1 border-secondary">
                        <span>
                        <i className="fa-brands fs-3 mt-0 pe-3 fa-facebook"></i>
                        </span>
                        <span>
                        <i className="fa-brands fs-3 mt-0 pe-3 fa-instagram"></i>
                        </span>
                        <span>
                        <i className="fa-brands fs-3 mt-0 pe-3 fa-youtube"></i>
                        </span>
                        <span>
                        <i className="fa-brands fs-3 mt-0 pe-3 mt-3 fa-tiktok"></i>
                        </span>
                    </div>
                </div>
            </div>
